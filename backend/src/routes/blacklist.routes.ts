...
import { createReport, getPublicReports, getAllReports, updateReportStatus, getUserReports } from '../controllers/blacklist.controller';
...
router.post('/', authenticateToken, uploadEvidenceMiddleware.single('evidence'), createReport);
