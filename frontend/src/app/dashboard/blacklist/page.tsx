    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-gray-500">
          Check the blacklist or report suspicious activity to keep the
          community safe.
        </p>
      </div>
          ...
          {loading ? (
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {filteredReports.map((report) => (
                <Card
                  key={report.id}
                  className="bg-card border-red-200 shadow-sm hover:shadow-md transition-shadow dark:border-red-900/50"
                >
                    ...
                    <div className="space-y-1.5 mb-3">
                      ...
                      {report.region && (
                        <div className="flex items-center text-sm text-foreground">
                          <span className="font-semibold text-muted-foreground w-16 text-xs uppercase tracking-wider">
                            Region
                          </span>
                      ...
                      {report.contactInfo && (
                        <div className="flex items-center text-sm text-foreground">
                          ...
                          <span className="font-mono bg-muted px-1 rounded text-red-600 dark:text-red-400">
                            {report.contactInfo}
                          </span>
                        </div>
                      )}
        ...
        <TabsContent value="report" className="mt-4">
          <Card className="max-w-2xl mx-auto bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>
                Submit details about a potential scammer. Your report will be
                reviewed by admins before being listed.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {submitStatus === "success" ? (
                <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Thank you for helping keep the community safe. Your report
                    is under review.
                  </p>
                  <Button
