...
const DUMMY_SELLERS = [
  {
    id: 1,
    name: "Emerald Coast Collective",
    lat: -33.8742,
    lng: 151.2018,
    description: "Indoor-grown selections",
  },
  {
    id: 2,
    name: "Harbour Green Supply",
    lat: -33.9126,
    lng: 151.1674,
    description: "small-batch cultivation with consistent quality control",
  },
  {
    id: 3,
    name: "River Plant Co.",
    lat: -33.8421,
    lng: 151.2487,
    description: "varieties grown using sustainable cultivation practices",
  },
  {
    id: 4,
    name: "Pacific Leaf Traders",
    lat: -33.8957,
    lng: 151.2213,
    description: "Independent grower collective",
  },
  {
    id: 5,
    name: "Camden Cuttings",
    lat: -33.8589,
    lng: 151.2745,
    description: "Marketplace vendor providing carefully curated premium buds",
  },
];
