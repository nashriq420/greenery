...
const DUMMY_LISTINGS = [
    {
        ...
        price: "$120",
        image: "https://images.unsplash.com/photo-1629831419736-2248554dc9b8?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
        ...
        price: "$85",
        image: "https://images.unsplash.com/photo-1558000143-a60d62cff829?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
        ...
        price: "$35",
        image: "https://images.unsplash.com/photo-1611078813892-abce3db69fbc?auto=format&fit=crop&q=80&w=600",
    ...
    },
    {
        ...
        price: "$25",
        image: "https://images.unsplash.com/photo-1589139265275-5c1a742886f6?auto=format&fit=crop&q=80&w=600",
        seller: "High Valley",
        location: "Top Shelf"
    }
];
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                    <div>
                        ...
                        <p className="text-lg text-muted-foreground max-w-xl">
                            Explore top-tier, lab-tested products from verified premium vendors.
                        </p>
                    </div>
                    <Link
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {DUMMY_LISTINGS.map((listing) => (
                        <div key={listing.id} className="group bg-card rounded-2xl overflow-hidden border border-border shadow-soft hover-lift cursor-pointer flex flex-col">
