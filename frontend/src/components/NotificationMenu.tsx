...
import { Bell, Check, Info, MessageSquare, Star, AlertTriangle, X } from 'lucide-react';
...
export default function NotificationMenu() {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-80 bg-card border-border rounded-lg shadow-xl border z-50 overflow-hidden">
