...
export default function ListingMap({
  ...
  const center = userLocation
    ...
    : [3.140853, 101.693207]; // Default to KL
              ...
              <Popup className="custom-popup">
                <div className="min-w-[240px] p-0">
                  ...
                  <div className="px-2 pb-2 text-gray-900">
                    <h3
                      className="font-extrabold text-base mb-1 truncate text-gray-900"
                      style={{ color: "#111827" }}
                    >
                      {listing.title}
                    </h3>
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-6 h-6 rounded-full overflow-hidden border border-gray-200">
                        <img
                          src={getImageUrl(
                            listing.seller?.sellerProfile?.profilePicture ||
                              "/default-avatar.png",
                          )}
                    ...
                    <Link
                      ...
                      className="block w-full py-2.5 bg-green-700 text-center text-sm font-bold rounded-lg hover:bg-green-800 transition shadow-sm"
