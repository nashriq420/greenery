                    ...
                    <CardContent className="space-y-6 pt-4 pb-8">
                        {!isActive && (
                            <div className="text-center mb-8">
                                ...
                                <span className="text-muted-foreground font-medium ml-2">USD / month</span>
                            </div>
                        )}
                        ...
                        {isActive && (
                            <div className="bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-900/50 rounded-lg p-4 mb-8 flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-bold text-green-900 dark:text-green-400">Active Subscription</h4>
                                    <p className="text-sm text-green-800 dark:text-green-500 tracking-tight">Your Premium perks are active until <strong>{endDateStr}</strong>.</p>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="space-y-4 px-2">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-foreground text-sm">Broadcast Messages</p>
                                    <p className="text-xs text-muted-foreground">Send updates and promotions directly to all your followers.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-foreground text-sm">Bigger Listing Icon & Premium Label</p>
                                    <p className="text-xs text-muted-foreground">Stand out on user profiles and search results with premium aesthetics.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-foreground text-sm">Priority Search Rankings</p>
                                    <p className="text-xs text-muted-foreground">Your products appear higher in relevant marketplace searches.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-foreground text-sm">Advanced Analytics Dashboard</p>
                                    <p className="text-xs text-muted-foreground">Gain deeper insights into customer behavior and listing performance.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-foreground text-sm">Verified Seller Badge</p>
                                    <p className="text-xs text-muted-foreground">Build instant trust with a verifiable, distinguished profile badge.</p>
                                </div>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <CardFooter className="bg-muted/50 border-t border-border flex-col gap-3 py-6">
                        {isActive ? (
                            ...
                            <>
                                ...
                                <p className="text-xs text-center text-muted-foreground">Cancel anytime. Terms & conditions apply.</p>
                            </>
                        )}
                    </CardFooter>
                </Card>
